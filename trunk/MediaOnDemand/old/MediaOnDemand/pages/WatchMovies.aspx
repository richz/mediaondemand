<%@ Page Language="C#" MasterPageFile="~/Media.Master" AutoEventWireup="true" CodeBehind="WatchMovies.aspx.cs"
                            ...
                            <tr>
                                <td align="left">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblGenre" Width="105px" runat="server" Text="Choose a genre:"></asp:Label>
                                            </td>
                                            <td>
                    ...
                    <div class="mediaGrid">
                        <asp:Panel ID="gridViewPanel" Height="100%" runat="server" ScrollBars="Auto">
                            <asp:GridView ID="gvMovies" Height="100%" Width="100%" runat="server" AllowPaging="True"
                                ...
                                OnPageIndexChanged="gvMovies_PageIndexChanged" OnPageIndexChanging="gvMovies_PageIndexChanging">
                                ...
                                <PagerStyle BackColor="#284775" Font-Size="X-Large" ForeColor="White" HorizontalAlign="Center" />
