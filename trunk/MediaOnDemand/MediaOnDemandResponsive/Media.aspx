    ...
    <asp:GridView ID="gvMedia" runat="server"
        ...
        <Columns>    
            <asp:TemplateField HeaderText="Cover">               
                <ItemTemplate>
                    <a id="lnkMediaLink" posterimageurl='<%# Eval("medPosterImageUrl") %>'
                        href="#" onclick="ForcePostBack(this)" mediatitle='<%# Eval("medTitle") %>'
                        param='<%# Eval("medLocation") %>' mediaid='<%# Eval("medId") %>'>
                    <asp:Image ID="imgCover" Width="118" Height="180" ImageUrl='<%# Bind("medPosterImageUrl") %>' runat="server" />
                    </a> 
                </ItemTemplate>                
                <HeaderStyle ForeColor="#428BCA" Height="50px" Width="200px" HorizontalAlign="Center" />
                <ItemStyle Height="190px" Width="150px" HorizontalAlign="Center" />
            </asp:TemplateField>        
            ...
            <asp:BoundField DataField="medGenre" HeaderText="Genre" SortExpression="medGenre" Visible="false" >
            <HeaderStyle HorizontalAlign="Center" />
            </asp:BoundField>
            ...
            <asp:BoundField DataField="medAlbum" HeaderText="Album" SortExpression="medAlbum" Visible="False" >
            <HeaderStyle HorizontalAlign="Center" />
            </asp:BoundField>
