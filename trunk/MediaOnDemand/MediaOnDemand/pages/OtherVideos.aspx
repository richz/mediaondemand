<%@ Page Language="C#" MasterPageFile="~/Media.Master" AutoEventWireup="true" CodeBehind="OtherVideos.aspx.cs"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:LinqDataSource ID="lnqVideos" runat="server" ContextTypeName="MediaOnDemand.StorageMediaDataContext"
        Select="new (medTitle, medLocation, medArtist, medDescription, medIsViewable, medGenre, medAlbum, medDuration, medVideoType, medDateAdded, medPosterImageUrl, medMediaType, medId, medFileExt, medRating)"
