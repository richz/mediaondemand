<%@ Page Language="C#" MasterPageFile="~/Media.Master" AutoEventWireup="true" CodeBehind="WatchTvSeries.aspx.cs"
                            ...
                            <asp:Panel ID="findByRecordCountPanel" runat="server">
                                <table width="100%">
                                    <tr>
                                            ...
                                            <asp:UpdatePanel ID="updatePanel" runat="server">
                                                <ContentTemplate>
                                                    <table>
                                                        <tr>
                                                            <td align="right">
                                                                <asp:Label ID="lblChooseSeries" Width="60px" runat="server" Visible="false" Text="Series: "></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 100%">
                                                                <asp:DropDownList ID="ddlList" runat="server" Visible="false" AutoPostBack="true"
                                                                    OnSelectedIndexChanged="ddlList_SelectedIndexChanged">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <asp:Label ID="lblChooseSeason" Width="60px" runat="server" Visible="false" Text="Season: "></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 100%">
                                                                <asp:DropDownList ID="ddlSeasonNumbers" runat="server" Visible="false" AutoPostBack="true">
                                                                </asp:DropDownList>
                                        ...
                                        <td id="PageSize" align="right" style="width: 200px">
                                            <table>
                                                <tr>
                                                    <td>
