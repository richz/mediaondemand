...
namespace MediaOnDemand.Tests
{
    ...
    /// <summary>
    ///This is a test class for HomeTest and is intended
    ///to contain all HomeTest Unit Tests
    ///</summary>
    [TestClass()]
    public class HomeTest
    {
        ...
        {
            Home_Accessor target = new Home_Accessor(); // TODO: Initialize to an appropriate value
