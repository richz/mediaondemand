...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-left:auto; margin-right: auto; width:100%">
        <AjaxData:Pager ID="MediaPager" PageSize="10" runat="server" LastPageText="" FirstPageText="" CssClass="PagerRowStyle"
            CurrentPageStyle-CssClass="PagerCurrentPage" Font-Size="X-Large" OtherPageStyle-CssClass="PagerOtherPage"
            PageChangedEvent="pageChanged" NextPageText="Next" PreviousPageText="Previous"
            ShowNumeric="False" ShowPreviousAndNext="True">
        </AjaxData:Pager>
    </div>
