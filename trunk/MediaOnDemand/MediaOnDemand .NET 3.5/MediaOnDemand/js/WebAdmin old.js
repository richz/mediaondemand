function showProgress(processType) {

    var progressIndicatorImage;
    ...
    progressIndicator.style.left = ((.4 * width) - (progressIndicator.style.width)) + 'px';
    ...
    if (processType == 'add')
        progressIndicatorImage = 'progressIndicatorAdd.gif';
    else if (processType == 'delete')
        progressIndicatorImage = 'progressIndicatorDelete.gif';

        progressIndicator.innerHTML = '<img id="progressImg" style="z-index:4; width: 200px; height: 200px" alt="" src="../images/ProgressIndicator/' + progressIndicatorImage + '"/>';
...
function AddButtonClick() {
    ...
    document.getElementById('ctl00_MainContent_hdnUpdateMode').setAttribute('value', 'add');
        
    showEditLightBox();
}

function EditButtonClick(link) {

    var mediaId = link.getAttribute('mediaid');
    
    document.getElementById('ctl00_MainContent_hdnUpdateMode').setAttribute('value', 'edit');
    document.getElementById('ctl00_MainContent_hdnMedId').setAttribute('value', mediaId);
    showEditLightBox();
}

function showEditLightBox(updateMode, hdnTitleID, hdnLocationID, hdnAlbumID, hdnArtistID, hdnDescriptionID, hdnDurationID, hdnGenreID, hdnIsViewableID, hdnMediaTypeID, hdnMedIdID, hdnPosterImageUrlID, hdnVideoTypeID) {
    ...
    if (updateMode == 'edit') {
        ...
        var value = $('input[name=hdnTitle]').val();
