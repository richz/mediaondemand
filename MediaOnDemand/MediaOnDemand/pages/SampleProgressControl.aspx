<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SampleProgressControl.aspx.cs" Inherits="MediaOnDemand.SampleProgressControl" %>
        ...
        <div id="form" class="demo">
            ...
            <script type="text/javascript">
                function onAjaxClick(sender){
                    ...
                    window.setTimeout(function(){
                        sender.value = 'Done!';
                        $find('ProgressControl10').set_percentage('+100');
                    }, Math.random() * 5000);
                }
            </script>            
