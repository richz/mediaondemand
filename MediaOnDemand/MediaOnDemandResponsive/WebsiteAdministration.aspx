...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <h1 id="PageHeader">Media Administration</h1>
    <br />
    <table style="margin-left: auto; margin-right: auto; width: 100%;">
        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <asp:Button ID="btnDeleteAllFromNetworkFolder" Enabled="true" CssClass="btn btn-lg btn-default" Width="100%" runat="server" Text="Delete records of selected media type" />
            </td>
        </tr>
        <%--<tr>
           <td class="alignLeft">
        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <asp:Button ID="btnDeleteAllRecords" Enabled="true" runat="server" CssClass="btn btn-lg btn-default" Width="100%" Text="Delete all records" />
            </td>
        </tr>
        <tr>
