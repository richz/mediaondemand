using MediaOnDemandLibrary.Properties;
...
namespace MediaOnDemand.Tests
{
    ...
    public class SettingsTest
    {
        ...
        /// <summary>
        ///A test for aspnetdbConnectionString2
        ///</summary>
        [TestMethod()]
        public void aspnetdbConnectionString2Test()
        {
            Settings target = new Settings(); // TODO: Initialize to an appropriate value
            string actual;
            actual = target.aspnetdbConnectionString2;
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
